<template>
    <div class="max-w-md mx-auto bg-white p-8 rounded-lg shadow-md">
        <h2 class="text-2xl font-bold mb-6 text-gray-900">Sharnoma ochish</h2>
        <form @submit.prevent="createContract">
            <div class="mb-4">
                <label for="content" class="block text-gray-700">Sharnoma maqsadi</label>
                <textarea v-model="content" id="content" class="mt-1 px-4 py-2 border border-gray-300 rounded-lg w-full"></textarea>
            </div>
            <div class="mb-4">
                <label for="loanId" class="block text-gray-700">Qarz ID</label>
